...
public:
    ...
    u8 get_drop_pair_frame(i8 x, direction::Type direction, const u8 heights[6]);
public:
...
public:
    ...
    void drop_puyo(i8 x, u8 height, cell::Type cell);
    void drop_pair(i8 x, direction::Type direction, cell::Pair pair);
    void drop_pair(i8 x, direction::Type direction, cell::Pair pair, const u8 heights[6]);
