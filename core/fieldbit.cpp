...
FieldBit::FieldBit(__m128i data)
{
    this->data = data;
};
...
{
    return FieldBit(this->data | other.data);
};
...
void FieldBit::set_bit(i8 x, i8 y)
{
    ...
    {
    case 0:
        this->data |= _mm_set_epi16(0, 0, 0, 0, 0, 0, 0, bit);
        break;
    case 1:
        this->data |= _mm_set_epi16(0, 0, 0, 0, 0, 0, bit, 0);
        break;
    case 2:
        this->data |= _mm_set_epi16(0, 0, 0, 0, 0, bit, 0, 0);
        break;
    case 3:
        this->data |= _mm_set_epi16(0, 0, 0, 0, bit, 0, 0, 0);
        break;
    case 4:
        this->data |= _mm_set_epi16(0, 0, 0, bit, 0, 0, 0, 0);
        break;
    case 5:
        this->data |= _mm_set_epi16(0, 0, bit, 0, 0, 0, 0, 0);
        break;
    }
};
...
FieldBit FieldBit::get_mask_pop()
{
    ...
    FieldBit result(m3 | m2_r | m2_l | m2_u | m2_d);
